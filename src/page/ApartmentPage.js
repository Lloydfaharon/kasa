...
export default function ApartmentPage() {
  ...
  if( selectedFlat == null) return<div> ...lording</div>;
      ...
      <div className='apartment'>
        ...
        <div className='apartment_section'>
          ...
          <div className='apartment_description'>
           <DescriptionAppartement title ="Description"
            content={selectedFlat.description}
           />
           <DescriptionAppartement title ="Equipement"
            content={selectedFlat.equipments.map( eq => < li>{eq}</li>)}
           />
